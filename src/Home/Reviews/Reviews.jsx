...
const Reviews = () => {
  ...
  return (
    <>
      <UserTitle heading="What Our Clients Say" title="testimonials" />
      <Swiper
        spaceBetween={30}
        centeredSlides={true}
        autoplay={{
  ...
  />
            ...
            <p className="text-justify text-neutral-700 font-normal font-['Inter'] mt-6">{review?.details}</p>
            <p className="text-center text-yellow-600 font-normal font-['Inter'] text-xl uppercase">{review?.name}</p>
          </SwiperSlide>
        ))}
      </Swiper>
    </>
